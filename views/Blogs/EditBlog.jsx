...
class EditBlog extends React.Component{
    render(){
        ...
        const {blog, users, loggedInUser} = this.props
        console.log("USERS FROM EDIT BLOG",users)
        // console.log(blog)
        return(
            <body>
                <head>
            ...
            <Navbar loggedInUser={loggedInUser}/>
                ...
                <form className="form" action={`/blog/${blog._id}?_method=PUT`} method="POST">
                    ...
                    <h5>Profile Pic:</h5> <input className="profilePicInput" type="text" name="authorImage" defaultValue={users.map(user=>loggedInUser===blog.author?user.profilePic:null)}></input>
